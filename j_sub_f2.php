  ...
  <footer>
    <div class="f_inner">
      <nav>
        ...
        <dl>
          <dt><a href="http://kokoroko.dothome.co.kr/bbs/bbs/board.php?bo_table=mi_event" title="이벤트">미에로 이벤트</a></dt>
          <dd><a href="http://kokoroko.dothome.co.kr/bbs/bbs/board.php?bo_table=mi_event" title="진행중인 이벤트">진행중인 이벤트</a></dd>
          <dd><a href="http://id.dothome.co.kr/bbs/bbs/border.php?bo_table=event" title="당첨자 발표">당첨자 발표</a></dd>
        </dl>
        <dl>
          <dt><a href="http://kokoroko.dothome.co.kr/bbs/bbs/board.php?bo_table=mi_notice" title="공지사항">공지사항</a></dt>
          <dd><a href="http://kokoroko.dothome.co.kr/bbs/bbs/board.php?bo_table=mi_notice" title="공지사항">New&Notice</a></dd>
        </dl>
        <dl>
    ...
    <address>
      <h2><a href="http://kokoroko.dothome.co.kr/0311" title="메인페이지로 바로가기">
          <img src="http://kokoroko.dothome.co.kr/0311/images/logo2.png" alt="하단로고"></a></h2>
